function MtrDatepicker(e) {
    ...
    var l, c = {
        ...
        i.className = "mtr-values", s.values.forEach(function(e) {
            ...
            r.className = "mtr-default-value", r.setAttribute("data-value", e), "minutes" === s.name && (0 <= e && e < 10) ? r.appendChild(document.createTextNode((e + "").padStart(2,"0"))) : r.appendChild(document.createTextNode(t)), 
